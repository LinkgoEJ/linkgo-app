-- supabase/migrations/005_seed_backfill_retry.sql
-- Idempotent backfill (retry-safe) using ONLY NOT EXISTS guards.
-- Assumes email-confirmed users exist in auth.users:
-- manager.alfa@example.com, manager.beta@example.com, ref1@example.com, ref2@example.com, coach1@example.com
...
-- ============================================================================
-- TALENT_DETAILS: ensure rows for ref1, ref2, coach1 with specified values
-- ============================================================================
-- ref1: 2 år, {U11,U13}, travel 15
...
-- ref2: 4 år, {U9,U11,U13}, travel 10
insert into public.talent_details
  (talent_id, is_referee, is_coach, experience_years, primary_levels, travel_km, hourly_rate)
...
-- coach1: 3 år, {U11,U13}, travel 20, hourly_rate 200
insert into public.talent_details
  (talent_id, is_referee, is_coach, experience_years, primary_levels, travel_km, hourly_rate)
...
-- ============================================================================
-- BOOKINGS: exactly two requested bookings if missing (CTE + UNION ALL + NOT EXISTS)
--   Alfa → Ref1: tomorrow 18:00–19:30 @ Skytteholms IP (“Träningsmatch U13”), role='referee'
--   Beta → Coach1: day after tomorrow 17:00–18:30 @ Zinkensdamms IP (“Teknikpass”), role='coach'
-- ============================================================================
with m as (
...
-- ============================================================================
-- Sanity SELECT: quick counts to verify backfill
-- ============================================================================
select
